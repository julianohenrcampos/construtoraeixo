...
import obraImg from "@/assets/imagem_obra.jpg?w=1920&format=webp&quality=75";
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-navy">
      <img
        ...
        height={1080}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-navy/80 via-navy/50 to-navy/30" />
      <BackgroundPaths />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <br />
          <span className="text-gradient">que move o Brasil.</span>
        </motion.h1>
        ...
        >
          ...
          <Link to="/contato">
            <Button
              size="lg"
              variant="outline"
              className="border-primary-foreground/20 text-primary-foreground bg-primary-foreground/5 hover:bg-primary-foreground/10 font-semibold px-8 py-6 text-base transition-colors"
            >
              Fale Conosco
            </Button>
          </Link>
